...
def test_merge_prices_news_no_previous_news():
    """
...
def test_merge_prices_news_unsorted_inputs():
    """
    ...
    assert len(merged) == 3
    assert "headline" in merged.columns
...
def test_merge_prices_news_empty_news():
    """
